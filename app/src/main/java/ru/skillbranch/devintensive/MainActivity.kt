...
class MainActivity : AppCompatActivity(), View.OnClickListener, TextView.OnEditorActionListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val qwestion = savedInstanceState?.getString("QUESTION") ?: Bender.Question.NAME.name
        messageEt.setText(savedInstanceState?.getString("MESSAGE") ?: "")
        benderObj = Bender(Bender.Status.valueOf(status), Bender.Question.valueOf(qwestion))

        Log.d("M_MainActivity","onCreate $status  $qwestion ${et_message.text.toString()}")
